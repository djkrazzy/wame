...
class ConsultaController extends VoyagerBaseController
{
    ...
    public function __construct()
{
    ...
    public function create(Request $request, )
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','cliente_id'));
    }
       ...
       // return $request->all();
        ...
        if (!$request->has('_tagging')) {
            if (auth()->user()->can('browse', $data)) {
                $redirect = redirect('admin/clientes/'.$request->cliente_id);
            } else {
                $redirect = redirect()->back();
            }
