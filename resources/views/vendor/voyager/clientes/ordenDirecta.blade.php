...
@section('page_header')
<h1 class="page-title">
VENTA   DIRECTA  <a data-toggle="modal" href="#items">           
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <!-- form start -->
                    {!! Form::open(['route' => 'trabajo.store.venta', 'autocomplete' => 'off']) !!}
                    ...
                    <tbody>
                        ...
                        <div class="form-group  col-md-3">
                         ...
                         <div class="form-group  col-md-3 ">
                             ...
                             <input type="number" class="form-control" name="pago_cliente" id="pago_cliente" step="any"   readonly  required>
